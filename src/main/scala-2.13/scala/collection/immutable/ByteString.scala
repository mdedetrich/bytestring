...
import scala.annotation.{nowarn, tailrec, unused, varargs}
...
object ByteString {
  ...
  private[immutable] object ByteString1C extends Companion {
  ...
  final class ByteString1C private (private val bytes: Array[Byte]) extends CompactByteString {
    ...
    /** INTERNAL API */
    private[immutable] def toByteString1: ByteString1 = ByteString1(bytes, 0, bytes.length)

    /** INTERNAL API */
    private[immutable] def byteStringCompanion = ByteString1C
    ...
    private[immutable] override def writeToOutputStream(os: ObjectOutputStream): Unit =
    ...
    private[immutable] def writeToBuffer(buffer: ByteBuffer, offset: Int): Int = {
    ...
    private[immutable] def appendToBuilder(buffer: ByteStringBuilder) = {
  ...
  private[immutable] object ByteString1 extends Companion {
  ...
  final class ByteString1 private (private val bytes: Array[Byte], private val startIndex: Int, val length: Int)
    ...
    private[immutable] def writeToOutputStream(os: ObjectOutputStream): Unit = {
      os.writeInt(length)
    ...
    private[immutable] def byteStringCompanion = ByteString1

    override def dropRight(n: Int): ByteString =
      dropRight1(n)

    /** INTERNAL API */
    private[immutable] def dropRight1(n: Int): ByteString1 =
      if (n <= 0) this
    ...
    /** INTERNAL API */
    private[immutable] def drop1(n: Int): ByteString1 = {
    ...
    private[immutable] def take1(n: Int): ByteString1 =
      if (n >= length) this
    ...
    /** INTERNAL API: Specialized for internal use, writing multiple ByteString1C into the same ByteBuffer. */
    private[immutable] def writeToBuffer(buffer: ByteBuffer): Int = {
  ...
  private[immutable] object ByteStrings extends Companion {
   ...
   */
  final class ByteStrings private (private[immutable] val bytestrings: Vector[ByteString1], val length: Int)
      extends ByteString
      with Serializable {
    ...
    private[immutable] def byteStringCompanion = ByteStrings
    ...
    private[immutable] def take0(n: Int): ByteString = {
  ...
  private[immutable] object Companion {
  ...
  private[immutable] sealed trait Companion {
...
sealed abstract class ByteString
  ...
  def apply(idx: Int): Byte
  private[immutable] def byteStringCompanion: ByteString.Companion
...
final class ByteStringBuilder extends Builder[Byte, ByteString] {
  ...
  private[immutable] def putByteArrayUnsafe(xs: Array[Byte]): this.type = {
    clearTemp()
